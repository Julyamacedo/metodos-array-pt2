...
Funcao: Percorre o array e TRANSFORMA cada item, retornando um NOVO array
...
console.log(' --- Exemplo 2: Extrair apenas os nomes (Intermediario) --- ');

const usuarios = [
    { id: 1, nome: 'Ana Silva', idade: 22 },
    { id: 2, nome: 'Bruno Costa', idade: 17 },
    { id: 3, nome: 'Carlos Souza', idadt: 0 },
];
...
// Regra de Back-End: formatar preco para o cliente e omitir dados sensíveis (custo interno)
