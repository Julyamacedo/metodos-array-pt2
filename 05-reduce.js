...
* Funcão: Processa todos os elementos do array e ACUMULA tudo em um
* ÚNICO VALOR FINAL (número, string, objeto agrupado, etc.).
*/

console.log(' ===EXEMPLOS COM reduce() === \n');

// Exemplo 1 (Basico): Somatoria de valores numericos
...
}, 0); // 0 e o valor inicial do acumulador
...
// Exemplo 2 (Intermediario): Somatoria de precos em carrinho simples
...
// Exemplo 3 (Back-End Real): Fechamento de pedido com quantidade e calculo de frete

console.log(" --- Exemplo 3: Fechamento de Pedido e Relatório (Back-End Real) --- ");

const pedido = [
    { id: 1, nome: "Hamburguer Artesanal", preco: 32.0, qtd: 2 },
    { id: 2, nome: "Batata Frita Rustica", preco: 16.0, qtd: 1 },
    { id: 3, nome: "Refrigerante Lata", preco: 7.0, qtd: 3 }
];

const taxaEntrega = 8.50;

// Calcula o valor dos itens multiplicando o preco unitario pela quantidade
