...
// Exemplo 1 (Basico): Verificar existência de número negativo
...
// Exemplo 2 (Intermediario): Checar pendencia cadastral de usuarios
...
//Exemplo 3 (Back-End Real): Alerta de reposicao de estoque
...
if (temEsgotado) {
return " ALERTA: Ha produtos esgotados no armazem. Acionar compras!";
}

return " Todos os produtos possuen estoque.";
}
