...
* Retorna true apenas se 100% dos itens satisfizerem a regra.
* ==
*/
console.log(" ===EXEMPLOS COM every() === \n");

// Exemplo 1 (Basico): Confirmar se todos os numeros são positivos

console.log(" --- Exemplo 1: Todos os núeros são positivos? (Básico) --- ");

const notas = [7.5, 8.0, 9.5, 6.0];

const todasPositivas = notas.every((noto) => noto >= 0);

console.log("Notas:", notas);
console.log("Todas as notas são validas (>- 0)?", todasPositivas);
console.log("\n");
...
// Exemplo 3 (Back-End Real): Validacao de Checkout no E-commerce

console.log(" --- Exemplo 3: Validaçao de estoque antes de fechar pedido (Back-End Real) --- ");
...
// Regra: cada item precisa ter quantidade comprada <- estoque disponivel
...
status: 400,
autorizado: false,
mensagen: "Falha no checkout: Um ou mais itens nao possuen estoque suficiente."
};
}
